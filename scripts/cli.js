...
const contractABI = require("../artifacts/contracts/Curveexchange.sol/Curveexchange.json").abi;

program
    .name("curveexchange-cli")
    .description("CLI tool for Curveexchange smart contract")
    .version("1.0.0");
